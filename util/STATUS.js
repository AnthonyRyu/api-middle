const STATUS = {
    S200 :{result : 200, resultDesc:"Complete",}, // 성공
		S201 :{result : 201, resultDesc:"선수 데이터 없음"},
		...
		E300 :{result : -300, resultDesc:"선수 DB 연동 실패"},
		E301 :{result : -301, resultDesc:"선수 DB 정보 암호화 실패"},
		E400 :{result : -400, resultDesc:"처리 실패"},
		E404 :{result : -404, resultDesc:"선수 파일 없음"},
